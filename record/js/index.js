...
function playAudio(recorderAudioAsBlob) {
    ...
    reader.onload = (e) => {
        ...
        uploadBlob(recorderAudioAsBlob)
    };
...
function uploadBlob(blob) {
    ...
    axios.post('http://localhost/MR/MR/upload.php', fd)
    .then(response => document.getElementById("result").innerHTML = response.data).catch(err => alert(err));
}
